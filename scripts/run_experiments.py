...
def generate_ml_fluid_params(  training_length, trained_model_params, testing_length, 
    ...
    params_dict = {
        'PREPROCESS' : { 
            ...
            'MATLAB_filename' :f'QGpsi_{xct}_{yct}_dt{dt:.2f}_ds{ds:.2f}_di{di:.2f}_dm{dm:.2f}_pertamp{pertamp:.1f}',
...
def run_experiment(resSize, spectral_radius, noise=1e-2, density=1e-1, leaking_rate=0.2, input_scaling=0.3, ridgeReg=0.01):  
...
def run_experiment_without_ftle(resSize, spectral_radius, noise=1e-2, density=1e-1, leaking_rate=0.2, input_scaling=0.3, ridgeReg=0.01): 
    ## Preparing parameters for entire experiment
    ## ml fluid params should link to qgftle params by  
    ## stream_function_estimated and stream_function_actual
    trained_model_params = { 
...
def run_experiment_only_ftle(resSize, spectral_radius, noise=1e-2, density=1e-1, leaking_rate=0.2, input_scaling=0.3, ridgeReg=0.01): 
    ## Preparing parameters for entire experiment
    ## ml fluid params should link to qgftle params by  
    ## stream_function_estimated and stream_function_actual
    trained_model_params = { 
...
if __name__ == '__main__':
    ...
    # resSize = 10000
    # spectral_radius = 3.0
    # for spectral_radius in [1.33, 2.33, 3.66, 4.0]:
         # for resSize in [10000]:
    # for spectral_radius in [1.5]:
    #      for resSize in [1000]: 
