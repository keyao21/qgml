...
def generate_ml_fluid_params(  training_length, trained_model_params, testing_length, trained_model_filename, stream_function_prefix ): 
    ...
    params_dict = {
        'PREPROCESS' : { 
            'sf_filename' : 'dgsf_0p1_128_64_0p1_0p2',
            'training_length'         : training_length,
            'training_data_filename'  : 'dgsf_0p1_128_64_0p1_0p2.TRAIN',
            'testing_data_filename'  : 'dgsf_0p1_128_64_0p1_0p2.TEST'  
        },
        'TRAIN' : { 
            'training_data_filename'  : 'dgsf_0p1_128_64_0p1_0p2.TRAIN',
        ...
        'GENERATE_STREAM_FUNCTION_FIELDS' : {
            ...
            'amp': 0.1,
            'epsilon': 0.2,
            'stream_function_filename' : 'dgsf_0p1_128_64_0p1_0p2'
        }
    }
    return params_dict
...
def run_experiment(resSize, spectral_radius): 
    ...
    training_length = 12000
    testing_length = 12000
    stream_function_prefix = f"dgsf_0p1_128_64_0p1_0p2{resSize}_{spectral_radius:.1f}"
