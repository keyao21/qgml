# conda activate
cd ../src
CONFIG_KEYS='QGds02di02dm02p3.100.1p8.actual QGds02di02dm02p3.100.1p8.est'
...
python compare_FTLE_fields.py --iters 20 --ftle_path_dirs $CONFIG_KEYS --ftle_animation_filename QGds02di02dm02p3.100.1p8.gif
